...
plt.scatter(years[-1],eq[-1],s=30,color='gold',zorder=9)
...
plt.text(2019,10.32,r'\textbf{2017}',fontsize=10,color='gold',ha='left')
...
gre, = plt.plot(years,tq,linestyle='-',linewidth=3,
         color='crimson',zorder=2)

plt.scatter(years[-1],tq[-1],s=30,color='gold',zorder=9)
...
plt.text(2017.6,1.8,r'\textbf{2017}',fontsize=10,color='gold',ha='left')
...
def update(num,years,eq,tq,ant,gre,bar):
    ...
    gre.axes.axis([1979,2017.8,-3,3.5])
    return bar,
