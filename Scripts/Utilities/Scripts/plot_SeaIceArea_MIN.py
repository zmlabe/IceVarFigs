...
plt.annotate(r'\textbf{GRAPHIC:} Zachary Labe (@ZLabe)',xy=(0.51,0.1),
             ...
             ha='center',va='center')
plt.annotate(r'\textbf{DATA:} September (1981-2010) SSMIS DMSP (NSIDC)',xy=(0.51,0.08),
             xycoords='figure fraction',color='darkgrey',fontsize=6,
             ha='center',va='center')
plt.annotate(r'\textbf{ARCTIC SEA ICE ANNUAL \underline{MIN}}',xy=(0.51,0.88),
             xycoords='figure fraction',color='darkgrey',fontsize=24,
             ha='center',va='center')

print('Completed: Figure plotted!')

plt.savefig(directoryfigure + 'seaiceMIN_climo.png',dpi=300)
